...
<form>
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <select onChange ={onChangePropertyType}  class="form-control" id="sel1">
    ...
    <div class="form-group col-md-6">
      ...
      <select class="form-control" id="sel1" onChange={onChangetransactionType}>
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input onChange = {onChangeAddress} type="text" class="form-control" id="inputText" placeholder="Location address"/>
    </div>
  </div>
  
</form>
<button onClick={handleSubmit} type="button" class="btn btn-secondary btn-lg btn-block">Add request </button>
