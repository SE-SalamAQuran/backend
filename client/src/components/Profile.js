...
class ProfilePage extends React.Component {
  ...
  UpdateProfileHandler = (e) => {
    ...
    //update-profile
    axios
      .post("http://localhost:5000/users/updateProfileImage", data, {
        headers: {
  ...
  onSaveEditInformation(e) {
    ...
    console.log(data);
    axios
      .put("http://localhost:5000/users/update/" + this.state.user_id, data)
      .then((res) => {
        res.status(200);
      })
  ...
  fetchUserDetails = () => {
    axios
      .get("http://localhost:5000/users/user/" + this.state.user_id, {
        headers: {
          "content-type": "application/json",
        },
      })
      ...
      return (
        <div>
          <div style={mystyle2}>
            ...
            <button style={{ paddingRight: 10 }} onClick={this.logOut}>
              logOut
            </button>
            <span> </span>
            ...
            <div style={mystyle0}>
              ...
              >
                ...
                <input
                  ...
                  onChange={this.changePhoneNumbe}
                  required
                />
                <br />
                <br />
                <br />
                <br />
                <button onClick={this.onSaveEditInformation}>
                  SaveChanges
                </button>
